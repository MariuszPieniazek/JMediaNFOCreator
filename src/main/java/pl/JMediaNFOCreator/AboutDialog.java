...
public class AboutDialog extends Dialog {
	...
	public void open() {
		...
		final Shell shellAboutDialog = new Shell(shellParent, SWT.DIALOG_TRIM
		...
		shellAboutDialog.setLocation(shellParentBounds.x
		...
		l.setText(JMediaNFOCreator.PROGRAM_NAME);
